package com.sam.project.AirBnb.security;
...
import com.sam.project.AirBnb.entities.enums.Role;
...
public class AuthService {
    ...
    public UserDTO signUp(SignUpRequestDTO signUpRequestDTO) {
        ...
        if (user != null) throw new RuntimeException("User is already present with this email id");
