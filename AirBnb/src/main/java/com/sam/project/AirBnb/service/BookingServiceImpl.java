...
import com.sam.project.AirBnb.strategy.PricingService;
...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDTO addGuests(Long bookingId, List<GuestDTO> guestDTOList) {
        ...
        for (GuestDTO guestDTO : guestDTOList) {
            ...
            // Create historical BookingGuest snapshot
            ...
            booking.getBookingGuests().add(bookingGuest);
        }
    ...
    public List<BookingDTO> getAllBookingsByHotelId(Long hotelId) {
        ...
        User user = getCurrentUser();
        log.info("Getting all bookings for the hotel wth id: "+hotelId);
    ...
    public HotelReportDTO getHotelReport(Long hotelId, LocalDate startDate, LocalDate endDate) {
        ...
        User user = getCurrentUser();
        log.info("Generating report for hotel wth id: "+hotelId);
